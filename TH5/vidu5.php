...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <?php
            ...
            {
	            $nghiem=giai_pt_bac_2(filter_input(INPUT_POST, 'a'),filter_input(INPUT_POST, 'b'),filter_input(INPUT_POST, 'c'));
            }
        ?>
        <form action="vidu5.php" method="post" >
            <table width="806" border="1">
                ...
                <tr>
                    <td colspan="4">Nghiệm <label for="textfield2"></label>
