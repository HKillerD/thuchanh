...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <?php 
            ...
            {
                $so_dau=filter_input(INPUT_POST, 'so_dau');
                $so_cuoi=filter_input(INPUT_POST, 'so_cuoi');
                $tong=0;
                $tong_chan=0;
                $tong_le=0;
                $tich=1;
        ...
        <form action="vidu4.php" method="post" >
            <table width="728" border="1">
                <tr>
                    <td width="152">Số bắt đầu</td>
                    <td width="169"><label for="textfield"></label>
                        <input type="text" name="so_dau" id="textfield" value="<?php if (isset($_POST["so_dau"])) echo filter_input(INPUT_POST, 'so_dau');?> "/>
                    </td>
                    <td width="148">Số kết thúc</td>
                    <td width="175"><label for="textfield2"></label>
                        <input type="text" name="so_cuoi" id="textfield2" value="<?php if (isset($_POST["so_cuoi"])) echo filter_input(INPUT_POST, 'so_cuoi');?> "/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="5" align="center" valign="middle"><input type="submit" name="button" id="button" value="Tính toán" /></td>
                </tr>
            </table>
        </form>
    </body>
