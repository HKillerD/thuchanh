    ...
    <body>
    	<?php
            ...
            if(isset($_POST['nhap_mang'])){
	            $mang_so = explode(",", filter_input(INPUT_POST,'nhap_mang'));
    	...
    	?>
	    <form action="vidu6-3.php" method="POST">
		    <table border="0">
			    <thead>
				    <tr>
			    ...
			    <tbody>
				    <tr>
					    <td>Mảng:</td>
					    <td><input type="text" name="nhap_mang" value="<?php echo filter_input(INPUT_POST, 'nhap_mang'); ?>" ></td>
				    </tr>
				    <tr>
